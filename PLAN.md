...
- [x] **S.1 — ⚡ Renombrar la etiqueta histórica a "Sprint N" en documentación y en el contrato de plan-status.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-1)

- [x] **S.2 — ⚡ Purgar de PLAN.md la evidencia de los ítems ya cerrados.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-2)

- [x] **S.3 — 🧠 Esquema `plan_items` y migración desde el parser existente.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-3)

- [x] **S.4a — ⚡ Recuperar al índice los 7 ítems invisibles y dar vía de reconciliación.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-4a)

- [x] **S.4b — 🧠 `plan:render` híbrido + gate de desincronización y de procedencia en pre-commit.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-4b)

- [x] **S.5 — ⚡ `bun run next` y arranque de sesión barato.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-5)

- [x] **S.6 — 🔍 Pantalla Sprint Board en el dashboard.** (cerrado 2026-09-09) → [evidencia](docs/done/bloque-S.md#bloque-s-s-6)

- [x] **S.6a — ⚡ Remate verificable del Bloque S antes de archivarlo.** (cerrado 2026-09-10) → [evidencia](docs/done/bloque-S.md#bloque-s-s-6a)

- [x] **S.7a — ⚡ Escape de regex roto en el gate de procedencia de specs.** (cerrado 2026-09-10) → [evidencia](docs/done/bloque-S.md#bloque-s-s-7a)

- [x] **S.7b — ⚡ SHA de un cierre anterior aceptado tras reabrir un ítem.** (cerrado 2026-09-10) → [evidencia](docs/done/bloque-S.md#bloque-s-s-7b)

- [x] **S.7c — ⚡ Historial shallow hace pasar un commit de prosa como commit de cierre.** (cerrado 2026-09-10) → [evidencia](docs/done/bloque-S.md#bloque-s-s-7c)
...
- [x] **UI.9.2 — 🧠 Modo Chat completo.** Estado vacío centrado con composer grande, buscar en la
