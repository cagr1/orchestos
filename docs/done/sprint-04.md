...
- S15.6 Validación: plan-architecture → anthropic/claude-opus-4-7 [planner]; sin config.yaml → legacy path idéntico a Sprint 3 — 2026-05-27
...
- S18.10 Commit final Sprint 4 `cca5f49` — 2026-05-27

**Decisiones de diseño Sprint 4**
...
- `executor` por tarea sigue ganando sobre config — compatibilidad total Sprint 3.
- CONSTITUTION.md es Markdown parseado con regex — sin DSL nuevo; Sprint 5 puede formalizarlo.
- `clarify` es heurística de palabras clave — semántica (LLM call extra) queda para Sprint 5.
- CONTEXT.md sustituye AGENTS.md en el prompt — AGENTS.md sigue siendo fuente de verdad para init.

**Lista prohibida Sprint 4** _(lo que NO se hizo — referencia histórica)_
- Dashboard / UI de ningún tipo → Sprint 6+.
- Sub-agentes con contextos aislados → Sprint 5+.
- Sandbox por tarea (`git worktree add`) → Sprint 5.
- Spec-kit completo (`orchestos spec <id>`) → Sprint 5.
...
**Métrica Sprint 4 — ✅ SÍ (2026-05-27)**
