...
;((g, f) => {
  ...
  var Pe = (l, e) => {
      for (var t in e) N(l, t, { get: e[t], enumerable: !0 })
    },
    Se = (l, e, t, n) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (const s of we(e))
          !ye.call(l, s) &&
            s !== t &&
            N(l, s, { get: () => e[s], enumerable: !(n = Oe(e, s)) || n.enumerable })
      return l
    }
  var $e = (l) => Se(N({}, '__esModule', { value: !0 }), l)
  var Ot = {}
  Pe(Ot, {
    Hooks: () => P,
    Lexer: () => x,
  ...
  var Le = ((l = '') => {
    ...
    D = { normal: X, gfm: Ze, pedantic: Ge },
    A = { normal: V, gfm: j, breaks: ct, pedantic: pt }
  var ht = { '&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;', "'": '&#39;' },
    fe = (l) => ht[l]
  function O(l, e) {
    if (e) {
...
`)
  ...
  var w = class {
    ...
    code(e) {
      ...
      if (t) {
        const n = this.options.pedantic ? t[0] : te(t[0]),
...
`),
              $ = this.blockquote(f)
            ;(i[i.length - 1] = $),
              (s = s.substring(0, s.length - R.raw.length) + $.raw),
              (r = r.substring(0, r.length - R.text.length) + $.text)
            break
          } else if (h?.type === 'list') {
            const R = h,
              f =
...
`),
              $ = this.list(f)
            ;(i[i.length - 1] = $),
              (s = s.substring(0, s.length - h.raw.length) + $.raw),
              (r = r.substring(0, r.length - R.raw.length) + $.raw),
...
`),
            ...
            const $ = this.rules.other.nextBulletRegex(f),
...
`,
              ...
              if (
                ((h = G),
                this.options.pedantic
                  ? ((h = h.replace(this.rules.other.listReplaceNesting, '  ')), (B = h))
                  : (B = h.replace(this.rules.other.tabCharGlobal, '    ')),
                re.test(h) || se.test(h) || Re.test(h) || Te.test(h) || $.test(h) || ne.test(h))
              )
                break
              if (B.search(this.rules.other.nonSpaceChar) >= f || !h.trim())
                p +=
                  `
` + B.slice(f)
              else {
...
`),
        ...
        for (const a of r.items) {
          ...
          if (a.task && (c?.type === 'text' || c?.type === 'paragraph')) {
            ...
            const p = this.rules.other.listTaskCheckbox.exec(a.raw)
            if (p) {
              const k = { type: 'checkbox', raw: p[0] + ' ', checked: p[0] !== '[ ]' }
              ;(a.checked = k.checked),
                r.loose
                  ? a.tokens[0] &&
          ...
          if (!r.loose) {
            const p = a.tokens.filter((h) => h.type === 'space'),
        ...
        if (r.loose)
          for (const a of r.items) {
            a.loose = !0
            for (const c of a.tokens) c.type === 'text' && (c.type = 'paragraph')
          }
        return r
      }
    }
...
`
    ...
    reflink(e, t) {
      ...
      if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
        const s = (n[2] || n[1]).replace(this.rules.other.multipleSpaceGlobal, ' '),
          r = t[s.toLowerCase()]
        if (!r) {
    ...
    codespan(e) {
      ...
      if (t) {
        ...
        return (
          s && r && (n = n.substring(1, n.length - 1)), { type: 'codespan', raw: t[0], text: n }
        )
      }
    }
    br(e) {
  ...
  var x = class l {
    ...
    constructor(e) {
      ...
      const t = { other: m, block: D.normal, inline: A.normal }
      this.options.pedantic
...
` + r.raw),
        ...
        if (this.options.extensions?.startBlock) {
          ...
          this.options.extensions.startBlock.forEach((c) => {
            ;(a = c.call({ lexer: this }, u)),
              typeof a == 'number' && a >= 0 && (o = Math.min(o, a))
          }),
...
` + r.text),
    ...
    inlineTokens(e, t = []) {
      ...
      for (; (s = this.tokenizer.rules.inline.anyPunctuation.exec(n)) !== null; )
        n =
          n.slice(0, s.index) + '++' + n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex)
      let r
    ...
    infiniteLoopError(e) {
      const t = 'Infinite loop on byte: ' + e
      ...
      for (const s of e)
        switch (((n = n.concat(t.call(this, s))), s.type)) {
          case 'table': {
            ...
            for (const i of r.rows) for (const o of i) n = n.concat(this.walkTokens(o.tokens, t))
            break
          }
          case 'list': {
            const r = s
      ...
      return (
        e.forEach((n) => {
          ...
          if (
            ...
            const r = this.defaults.renderer || new y(this.defaults)
          ...
          if (n.tokenizer) {
            const r = this.defaults.tokenizer || new w(this.defaults)
          ...
          if (n.hooks) {
            const r = this.defaults.hooks || new P()
    ...
    parseMarkdown(e) {
      return (n, s) => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            const u = i.hooks ? await i.hooks.preprocess(n) : n,
...
Please report this to https://github.com/markedjs/marked.`),
          ...
          const s = '<p>An error occurred:</p><pre>' + O(n.message + '', !0) + '</pre>'
  ...
  g.options = g.setOptions = (l) => (M.setOptions(l), (g.defaults = M.defaults), Q(g.defaults), g)
  g.getDefaults = _
  g.defaults = T
  g.use = (...l) => (M.use(...l), (g.defaults = M.defaults), Q(g.defaults), g)
  g.walkTokens = (l, e) => M.walkTokens(l, e)
